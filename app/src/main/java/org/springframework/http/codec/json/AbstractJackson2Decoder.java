 ...
 */
// Copy paste from sources to add Custom Logs
...
import com.nalepa.publishon.TestAppLogger;
 ...
 */
// Copy pasted from sources with custom logger
public abstract class AbstractJackson2Decoder extends Jackson2CodecSupport implements HttpMessageDecoder<Object> {
    ...
    public Object decode(DataBuffer dataBuffer, ResolvableType targetType,
        ...
        try {
            ...
            TestAppLogger.INSTANCE.log(this, "Decoding webClient response");
